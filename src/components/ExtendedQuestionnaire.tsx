...
const ExtendedQuestionnaire = () => {
  ...
  const getGoalsForGrade = (grade: string) => {
    ...
    } else if (grade.includes('Студент')) {
      return ['Проекты 💡', 'Курсовые работы 📄', 'Диплом/ВКР 🎓', 'Стажировки 💼', 'Изучение новых навыков 🚀'];
    }
    // Default for all cases
    return ['ЕГЭ 📚', 'ОГЭ 📝', 'Олимпиады 🏆', 'Проекты 💡', 'Курсовые работы 📄', 'Диплом/ВКР 🎓', 'Стажировки 💼', 'Изучение новых навыков 🚀'];
  };
